...
interface AstroConsentCategories {
  essential?: boolean
  analytics?: boolean
  marketing?: boolean
}
...
declare global {
  interface Window {
    gtag?: Gtag.Gtag
    astroConsent?: {
      get(): { updatedAt: number; expiresAt: number; categories: AstroConsentCategories } | null
      set(categories: AstroConsentCategories): void
      reset(): void
    }
  }
}
